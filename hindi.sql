...
movie_id int,
    ...
    insert into hindi_movies (movie_id, movie_name, movie_release_date, movie_ticket_price, movie_duration,  
...
insert into hindi_movies values (8, 'RRR', '2025-09-12', 500.0, '3:00', 
    5.8, 'NTR Charan', 'tttt', 'yogaraj bat', 100.34, 200.65, '2025-09-12 10:00:00', 2000);
    
insert into hindi_movies values (9, 'Arya-2', '2025-09-12', 500.0, '3:00', 
    5.8, 'allu arjun', 'tttt', 'yogaraj bat', 100.34, 200.65, '2025-09-12 10:00:00', 2000);
    
insert into hindi_movies values (10, 'Yamadoga', '2025-09-12', 500.0, '3:00', 
    5.8, 'NTR ', 'tttt', 'zzzzz', 100.34, 200.65, '2025-09-12 10:00:00', 2000);
    
    insert into hindi_movies values (11, 'Yavadu', '2025-09-12', 500.0, '3:00', 
    5.8, 'Charan', 'tttt', 'ffff', 100.34, 200.65, '2025-09-12 10:00:00', 2000);
    
    insert into hindi_movies values (12, 'Chiruta', '2025-09-12', 500.0, '3:00', 
    5.8, ' Charan', 'tttt', 'fffff', 100.34, 200.65, '2025-09-12 10:00:00', 2000);
    
    insert into hindi_movies values (13, 'SwSudheer', '2025-09-12', 500.0, '3:00', 
    5.8, 'Sudheer', 'tttt', 'chasfgk', 100.34, 200.65, '2025-09-12 10:00:00', 2000);
    
    insert into hindi_movies values (14, 'Galoddu', '2025-09-12', 500.0, '3:00', 
    5.8, 'Sudheer', 'tttt', 'chasfgk', 100.34, 200.65, '2025-09-12 10:00:00', 2000);
    
    insert into hindi_movies values (13, 'G.O.A.T', '2025-09-12', 500.0, '3:00', 
    5.8, 'Sudheer', 'tttt', 'chasfgk', 100.34, 200.65, '2025-09-12 10:00:00', 2000);
